  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        bool USE_WRISTBAND = DataController.instance.devicesSetting["USE_WRISTBAND"]!,
            ...
            USE_KITCHEN_DEVICE = DataController.instance.devicesSetting["USE_KITCHEN_DEVICE"]!;
          ...
          children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Theme.of(context).colorScheme.onSurface.withValues(
                              alpha:
                                  DataController.instance.devicesSetting["USE_DOOR_DEVICE"] == true
                                  ? 1
                                  : 0.7,
                            ),
                          ),
                            ...
                            children: [
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          onSubmitted: (value) => FirebaseDB.updateData("setting", {
                              ...
                              Positioned(
                                ...
                                child: GestureDetector(
                                  onTap: () => DataController.instance.updateDevicesSetting(
                                    "USE_DOOR_DEVICE",
                                    !DataController.instance.devicesSetting["USE_DOOR_DEVICE"]!,
                                  ),
                                  child: Icon(
            ...
            Theme(
              ...
              child: SwitchListTile(
                ...
                subtitle: Text("Turn on to enable wristband", style: TextStyle(fontSize: 14)),
                secondary: Icon(Icons.watch, size: 30),
                value: USE_WRISTBAND,
                onChanged: (USE_WRISTBAND) {
                  setState() => USE_WRISTBAND = !USE_WRISTBAND;
                  DataController.instance.updateDevicesSetting("USE_WRISTBAND", USE_WRISTBAND);
                },
              ),
            ),
